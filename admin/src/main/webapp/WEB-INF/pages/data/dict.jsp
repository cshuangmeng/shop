...
<script type="text/javascript" src="${pageContext.servletContext.contextPath }/resources/js/data/dict.js"></script>
...
<body>
    ...
    <div id="mws-wrapper">
        ...
        <div id="mws-container" class="clearfix">
            ...
            <div class="container">
            	...
            	<div id="dict_list_div" class="mws-panel grid_8">
                	<div class="mws-panel-header">
                    	<span class="mws-i-24 i-graph">字典维护</span>
                    	<div class="mws-collapse-button">
                    		<span></span>
                    	</div>
                    </div>
                    <div class="mws-panel-body">
                   	<table id="dict_list_table" class="mws-datatable mws-table">
                        <thead>
                        </thead>
                        <tbody>
                        </tbody>
	...
	<div id="del-dict-dialog"></div>
	<!-- 字典信息编辑表单 -->
    <div id="edit_dict_info_div">
    		...
    		<div class="mws-form-inline">
    			<div class="mws-form-row">
    				...
    				<div class="mws-form-item small">
    					<input type="text" class="mws-textinput" name="dictCode" />
    				</div>
    			</div>
    			<div class="mws-form-row">
    				<label>字典名称</label>
    				<div class="mws-form-item small">
    					<input type="text" class="mws-textinput" name="dictName" />
    				</div>
    			</div>
    			<div class="mws-form-row">
    				<label>字典值</label>
    				<div class="mws-form-item small">
    					<input type="text" class="mws-textinput" name="dictValue" />
    				</div>
    			</div>
    			<div class="mws-form-row">
    				<label>排列序号</label>
