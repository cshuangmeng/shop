...
<script type="text/javascript" src="${pageContext.servletContext.contextPath }/resources/js/data/bd.js"></script>
    ...
    <div id="mws-wrapper">
        ...
        <div id="mws-container" class="clearfix">
            ...
            <div class="container">
            	...
            	<div id="bd_list_div" class="mws-panel grid_8">
                	<div class="mws-panel-header">
                    	<span class="mws-i-24 i-graph">地推人员</span>
                    	<div class="mws-collapse-button">
                    		<span></span>
                    	</div>
                    </div>
                    <div class="mws-panel-body">
                   	<table id="bd_list_table" class="mws-datatable mws-table">
                        <thead>
                        </thead>
                        <tbody>
                        </tbody>
    	...
    	<form class="mws-form" action="" method="post">
    		...
    		<div class="mws-form-inline">
    			...
    			<div class="mws-form-row">
    				<label>姓名</label>
    				<div class="mws-form-item small">
    					<input type="text" class="mws-textinput" name="fullname" />
    				</div>
    			</div>
    			<div class="mws-form-row">
    				<label>帐号</label>
