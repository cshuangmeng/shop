package com.gaoling.webshop.order.service;
...
import com.gaoling.webshop.pay.service.PayRefundSummaryService;
import com.gaoling.webshop.pay.service.PayService;
import com.gaoling.webshop.pay.service.UserTradeLogService;
import com.gaoling.webshop.system.pojo.PayParam;
...
import com.gaoling.webshop.tribe.service.TribeMemberService;
import com.gaoling.webshop.tribe.service.TribeService;
import com.gaoling.webshop.user.pojo.Address;
import com.gaoling.webshop.user.pojo.ShoppingCar;
...
public class OrderService extends CommonService{
	...
	public Result confirmOrder(String itemIds){
		...
		List<Map<Object,Object>> car=shopMap.entrySet().stream().map(k->{
			...
			int totalPoint=k.getValue().stream().map(v->{
				...
				return Math.round(price*Float.parseFloat(v.get("amount").toString()));
			}).reduce((a,b)->a+b).get();
